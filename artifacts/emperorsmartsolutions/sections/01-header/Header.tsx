...
export const Header: React.FC<HeaderProps> = ({ className = '', style }) => {
  return (
    <section className={`${styles.root} ${className}`} style={style}>
      <header className="fixed w-full backdrop-blur-md transition-all duration-300 border-b border-white/5 top-0 left-0 right-0 bg-midnight shadow-lg" id="header">
