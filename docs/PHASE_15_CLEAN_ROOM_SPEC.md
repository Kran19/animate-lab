# AnimateLab — Phase 15 Clean-Room Reproduction Specification
...
6. **Forensic Evidence Verification**: All 9 evidence files in `evidence/` must be verified and readable.
